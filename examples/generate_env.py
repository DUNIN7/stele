...
#
# This file holds a LIVE secret (STELE_SECRET_KEY below) — never commit it.
# The repo's .gitignore already excludes `.env`; keep it that way if you rename
# or relocate the file, and never paste its contents into a commit, issue, or chat.
