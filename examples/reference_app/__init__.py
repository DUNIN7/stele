...
It is the clone-and-run-and-*use* proof: a stranger stands up Postgres, runs
Stele's baseline migration, fills a generated ``.env``, starts this app, and
registers a real passkey in a browser that round-trips through ``stele.router``.
